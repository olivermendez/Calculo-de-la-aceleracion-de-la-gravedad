...
En esta ocasión, vamos a ilustrar el caso del péndulo simple. Así como lo detalla el ejercicio (Tarea 1), es un sistema idealizado de un solo grado de libertad, un objeto de masa m, sostenido por un hilo cuya masa es despreciable que puede describirse expresando en función del tiempo su distancia angular a una dirección de referencia, tal como la vertical en un determinado punto, el considerar este sistema como idealizado se restringe las observaciones a excluir la fricción presente.
...
La estructura de almacenamiento de la información producida tiene que contener forzosamente:
...
## Fuentes de cada uno de los scripts/programas empleados para obtener lo solicitado. Los scripts/programas deben estar cuidadosamente comentados de manera de que sea entendible su propósito y lógica. [40%]


## Documento con descripción detallada sobre cómo llevar a cabo la captación de datos y su procesamiento. [20%]

## Soporte de exportación de la data y resultados, así como API de su uso en la componente de realización seleccionada. [20%]
